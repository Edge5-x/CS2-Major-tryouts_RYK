...
export const metadata: Metadata = {
  ...
  description: 'Register for the biggest CS2 tournament in Rahim Yar Khan. $500 prize pool. Etihad Club, Feb 15, 2026. Individual registration - get drafted into teams!',
  ...
  openGraph: {
    ...
    description: 'Register for the biggest CS2 tournament in RYK. $500 prize pool. Feb 15 at Etihad Club.',
    type: 'website',
  },
}
